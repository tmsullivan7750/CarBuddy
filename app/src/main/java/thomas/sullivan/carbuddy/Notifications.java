...
public class Notifications extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            SimpleCircleButton.Builder builder = new SimpleCircleButton.Builder()
                    ...
                    .normalColor(getResources().getColor(R.color.white)).highlightedColor(getResources().getColor(R.color.pink)).listener(new OnBMClickListener() {
                        ...
                        public void onBoomButtonClick(int index) {
                            startActivity(new Intent(Notifications.this, menuOnClicks.get(index)));
                        }
                    });
        ...
        TextView notificationsTemp = (TextView) findViewById(R.id.notificationsTemp);

        notificationsTemp.setText("Notifications Temp Page");
