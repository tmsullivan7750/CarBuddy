...
public class Settings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            SimpleCircleButton.Builder builder = new SimpleCircleButton.Builder()
                    ...
                    .normalColor(getResources().getColor(R.color.white)).highlightedColor(getResources().getColor(R.color.pink)).listener(new OnBMClickListener() {
                        ...
                        public void onBoomButtonClick(int index) {
                            startActivity(new Intent(Settings.this, menuOnClicks.get(index)));
                        }
                    });
        ...
        TextView settingsTemp = (TextView) findViewById(R.id.settingsTemp);

        settingsTemp.setText("Settings Temp Page");
